          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-3">
                <label for="size">Size:</label>
                  <select class="form-control" id="size" name="size">
                    <option value="<?php echo e($product[0]->size); ?>"><?php echo e($product[0]->size); ?></option>
              ...
              <div class="col-md-3">
                ...
                <input class="form-control" id="available" type="number" aria-describedby="nameHelp" placeholder="Enter Quantity" name="available" min="1" value="<?php echo e($product[0]->available); ?>">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-3">
                ...
                <input class="form-control" id="price" type="number" aria-describedby="nameHelp" placeholder="Price in number" name="price" min="0" value="<?php echo e($product[0]->price); ?>">
              ...
              <div class="col-md-3">
                ...
                <input class="form-control" id="cost" type="number" aria-describedby="nameHelp" placeholder="Cost in number" name="cost" min="0" value="<?php echo e($product[0]->cost); ?>">
