...
<body class="bg-dark">
  ...
  <div class="container">
                ...
                <form method="post" action="/login" id="login">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="usernameEmail" type="text" aria-describedby="emailHelp" placeholder="Enter username / email" name="usernameEmail" value="<?php echo e(old('usernameEmail')); ?>">
                        <?php if($errors->has('userDNE')): ?>
                          <small id="userDNE" class="text-danger"><?php echo e($errors->first('userDNE')); ?></small>
                        <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($errors->has('pwdERR')): ?>
                          <small id="pwdERR" class="text-danger"><?php echo e($errors->first('pwdERR')); ?></small>
                        <?php endif; ?>
    ...
    <script src="<?php echo e(asset('custom_public/login-validate.js')); ?>"></script>
